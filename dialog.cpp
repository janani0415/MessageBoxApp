...
{
    QMessageBox::information(this,"Janani A 212218106101","This is information");
}

void Dialog::on_pushButton_2_clicked()
{
    QMessageBox::StandardButton reply;
          reply = QMessageBox::question(this, "Janani A", "Do you like Biriyani?", QMessageBox::Yes|QMessageBox::No);
